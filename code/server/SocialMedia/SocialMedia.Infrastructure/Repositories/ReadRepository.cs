...
namespace SocialMedia.Infrastructure.Repositories
{
        ...
        where TEntity : Entity<TEntityId>
    {
        ...
        public async Task<IEnumerable<TEntity?>> GetMultiple<TEntity>(int key, string _query)
        {
        ...
        public async Task<TEntity?> GetSingle<TEntity>(Guid key, string _query)
        {
            var parameterizedQuery = new QueryDefinition(
            query: _query)
            .WithParameter("@partitionKey", key.ToString());
